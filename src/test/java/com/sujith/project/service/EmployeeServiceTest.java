...
class EmployeeServiceTest {
    ...
    @Test
    void testEmployeeService_deleteById_Valid() {
        when(employeeDao.delete(1)).thenReturn(EmployeeFiles.getSingleEmployee());
        assertEquals(EmployeeFiles.getSingleEmployee(), employeeService.delete(1));

    }

    @DisplayName("DeleteById-throwInvalidDataAccessApiUsageException")
    @Test
    void deleteById_throwInvalidDataAccessApiUsageException() {
        when(employeeDao.delete(2)).thenThrow(InvalidDataAccessApiUsageException.class);
        assertThrows(InvalidDataAccessApiUsageException.class, () -> employeeService.delete(2));
    }
    ...
    @DisplayName("findAll_valid")
     void findAll_valid() {
        when(employeeDao.findAll()).thenReturn(EmployeeFiles.getListOfEmployee());
    ...
    void findAll_throwApiRequestException() {
        when(employeeDao.findAll()).thenThrow(ApiRequestException.class);
    ...
    @Test
     void saveEmployee_valid() {
        when(employeeDao.save(EmployeeFiles.getSingleEmployee())).thenReturn(EmployeeFiles.getSingleEmployee());
        assertEquals(EmployeeFiles.getSingleEmployee(), employeeService.save(EmployeeFiles.getSingleEmployeeDto()));
    }


    @DisplayName("saveEmployee_throwIllegalStateException")
    @Test
     void saveEmployee_throwIllegalStateException() {
        when(employeeDao.save(EmployeeFiles.getSingleEmployee())).thenThrow(IllegalStateException.class);
        assertThrows(IllegalStateException.class, () -> employeeService.save(EmployeeFiles.getSingleEmployeeDto()));
    }

    @DisplayName("saveEmployee_throwIllegalArgumentException")
    @Test
     void saveEmployee_throwIllegalArgumentException() {
        when(employeeDao.save(EmployeeFiles.getSingleEmployee())).thenThrow(IllegalArgumentException.class);
        assertThrows(IllegalArgumentException.class, () -> employeeService.save(EmployeeFiles.getSingleEmployeeDto()));
    }

    @DisplayName("saveEmployee_throwInvalidDataAccessApiUsageException")
    @Test
     void saveEmployee_throwInvalidDataAccessApiUsageException() {
        when(employeeDao.save(EmployeeFiles.getSingleEmployee())).thenThrow(InvalidDataAccessApiUsageException.class);
        assertThrows(InvalidDataAccessApiUsageException.class, () -> employeeService.save(EmployeeFiles.getSingleEmployeeDto()));
    }
